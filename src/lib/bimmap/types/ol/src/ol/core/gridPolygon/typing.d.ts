  ...
  namespace OL {
    interface IGridPolygon
      extends IFeatureHandle<"ol">,
        State.IBaseState<"ol", ServiceOptions.IGridPolygon> {
      /**
       ...
       */
      addRightClick(callBack: BaseStateEventCallback<"ol">, name: string): this;
      /**
       * @description 获取 Feature 的中心点
       *
       * @param {IBimMapHandle["ol"]["feature"]} feature 传入的 Feature 实例
       * @return {Number[]} 返回一个经纬度数组
       */
      getCenterCoordinates(feature: IBimMapHandle["ol"]["feature"]): LngLatType;
