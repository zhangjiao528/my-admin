namespace BimMap {
  namespace Csm{
    ...
    interface ILayerGroupAdminOptions
      extends ServiceOptions.ILayerGroupAdminOptions<"cesium"> {}

    interface ILayerGroupAdmin
      extends Pick<IFeatureHandle<"cesium">, "map">,
        IDispose {
      /**
       * 添加图层组
       * @methor
       * @param {string} groupName 组名称
       * @param {IBimMapHandle["cesium"]["layer"] | IBimMapHandle["cesium"]["layer"][]} layer 图层或图层数组
       ...
       */
      addLayerGroups(
        options: ServiceOptions.ILayerGroupAdminOptions<"cesium">["group"]
        /**
         * 删除图层组
         * @param groupName
         */
