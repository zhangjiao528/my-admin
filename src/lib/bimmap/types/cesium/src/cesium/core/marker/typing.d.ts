namespace BimMap {
  namespace Csm{
    interface IDomMarker extends BimMap.IDispose {
       ...
       *
       * @param {State.BaseStateEventCallback<"cesium">} callBack 回调函数
       */
      addClick(callBack: State.BaseStateEventCallback<"cesium">): this;
    }
    var DomMarker: IServiceConstructor<"cesium", IOverlayOptions, IDomMarker>;

    interface IIconMarker
      extends IFeatureHandle<"cesium">,
        State.IBaseState<"cesium", ServiceOptions.IIconMarkerOptions> {
      /**
