namespace BimMap {
  namespace Csm {
    ...
    interface I3DService extends IDispose {
       ...
       * 加载三维模型
       */
      S3MTiles(options?: Csm.IS3MTilesOptions): Csm.IS3MTiles;
       ...
       */
      obliquePhotography(
        options?: Csm.IObliquePhotographyOptions
      ): Csm.IObliquePhotography;
      /**
       * 加载地形
       * @param options
       */
      Terrain(options?: Csm.ITerrainOptions): Csm.ITerrain;
      /**
       * 加载图元
       * @param options
       */
      Primitive(options?: BimMap.Csm.IPrimitiveOptions): BimMap.Csm.IPrimitive;
      /**
       * 数据漫游
       * @param options
       */
      DataRoam(options?: Csm.IDataRoamOptions): Csm.IDataRoam;
  ...
  namespace Style {
    namespace Csm {
      interface IConvertStyleOptions {
        ...
        // circle?: Cesium.CircleGeometry.ConstructorOptions;
  ...
  interface IOneMapCesium
    extends BimMap.IService<"cesium", BimMap.Csm.ICesiumOptions> {
    /**
     * 原生cesium对象
     */
  ...
  interface IOneMapCesiumConstructor {
    new (options: Csm.ICesiumOptions);
  }

  type CService = IOneMapCesiumConstructor &
    IOneMapCesium &
    ILayerHandle<"cesium">;
}
