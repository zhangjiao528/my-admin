namespace BimMap {
  namespace Supermap{
    ...
    interface ILayerGroupAdminOptions
      extends ServiceOptions.ILayerGroupAdminOptions<"supermap"> {}

    interface ILayerGroupAdmin
      extends Pick<IFeatureHandle<"supermap">, "map">,
        IDispose {
      /**
       * 添加图层组
       * @methor
       * @param {string} groupName 组名称
       * @param {IBimMapHandle["supermap"]["layer"] | IBimMapHandle["supermap"]["layer"][]} layer 图层或图层数组
       ...
       */
      addLayerGroups(
        options: ServiceOptions.ILayerGroupAdminOptions<"supermap">["group"]
        /**
         * 删除图层组
         * @param groupName
         */
      ...
      zoomToCenter(
        ...
        zoomLevel?: number,
        fitOptions?: Omit<
          State.IAddClickParams<"supermap">,
