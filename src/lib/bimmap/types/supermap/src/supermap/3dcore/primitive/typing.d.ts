namespace BimMap {
  namespace Supermap {
    ...
    interface IPrimitive
      ...
      load3Dtiles(
        options:
          | BimMap.Supermap.ILoad3DtilesOptions
          | BimMap.Supermap.ILoad3DtilesOptions[],
        params?: BimMap.Supermap.ILoadGltfParams
       ...
       */
      find(name: string, pType: BimMap.Supermap.PrimitiveType): any;
      /**
       * 注册事件
       * @param callBack 事件回调
       * @param type 事件类型
      ...
      on(
        ...
        pType: BimMap.Supermap.PrimitiveType = PrimitiveType.gltf
      ): this;
      /**
       * 取消事件
       * @param callBack 事件回调
    ...
    var Primitive: IServiceConstructor<"supermap", IPrimitive>;
  }
}
