namespace BimMap {
  namespace Supermap {
    ...
    interface IS3MTiles
      extends IServiceConstructor<"supermap", IMapAny>,
       ...
       */
      filter(
        callback: (data: BimMap.IMapAny, layer: BimMap.IMapAny) => boolean,
        modelName?: string
      ): IMapAny[] | null;
       ...
       * @param name 图层名称或对象
       */
      layerToBottom(name: string | BimMap.IMapAny): this;
      /**
       * 图层置顶
       * @param name 图层名称或对象
       */
      layerToTop(name: string | BimMap.IMapAny): this;
      /**
       * 定位到模型
       * @param layer
       */
      zoomTo(layer: any): this;
      /**
       * 根据名称删除模型
       * @param name
       */
    ...
    var S3MTiles: IServiceConstructor<"supermap", IS3MTiles>;
  }
}
